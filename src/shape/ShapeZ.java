...
public class ShapeZ extends Shape {
	...
	public ShapeZ(Graphics g, Point origin, int size) {
		super(g, origin, size);
	...
	public void drawShape() {
		...
		this.draw(new Color(137,66,244));
	...
	private void setVertical() {
		...
		isVertical = true;
		edge1 = new VerticalEdge(origin.x,origin.y+size,origin.y+size*3);
		...
		edge4 = new VerticalEdge(origin.x+size*2,origin.y,origin.y+size*2);
	}
	...
	private void setHorizontal() {
		...
		edge4 = new VerticalEdge(origin.x+size*3,origin.y+size,origin.y+size*2);
	}
